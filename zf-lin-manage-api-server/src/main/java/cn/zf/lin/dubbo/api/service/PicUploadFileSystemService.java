...
import cn.zf.lin.dubbo.api.vo.PicUploadResult;
...
public class PicUploadFileSystemService {
    ...
    public PicUploadResult upload(MultipartFile uploadFile) {
        ...
        String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath,
                "F:\\code\\zf-lin\\lin-upload"),
                "\\", "/");
        fileUploadResult.setName("http://image.lin.com" + picUrl);
    ...
    private String getFilePath(String sourceFileName) {
        String baseFolder = "F:\\code\\zf-lin\\lin-upload" + File.separator
                + "images";
